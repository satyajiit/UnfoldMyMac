...
Open a design in **Dynamic Wallpapers** or **Creative Scenes**, then choose **Customize** below its preview. Feature badges identify its inputs before you connect anything. You can browse and preview before connecting personal data; required setup opens before applying a design. The [README’s data section](https://github.com/satyajiit/UnfoldMyMac#living-wallpapers) describes the available sources.
...
The hook receiver saves identifiers, timestamps, and counters. It discards prompts, commands, and responses, and does not approve or redirect Codex work. The [hook setup and data contract](https://github.com/satyajiit/UnfoldMyMac/blob/main/UnfoldMyMac/WALLPAPER_ENGINE.md#data-sources) and [activity provider](https://github.com/satyajiit/UnfoldMyMac/blob/main/UnfoldMyMac/Sources/UnfoldMyMacKit/Features/Wallpaper/Data/CodexActivityProvider.swift) describe what a new scene can use.
...
Previewing or running Aurora Observatory fetches NOAA's public OVATION aurora forecast and planetary Kp readings. No account or personal data connection is needed. The app shares a five-minute cache across the preview and desktop views, and labels cached or stale readings when a feed is unavailable. The [NOAA provider](https://github.com/satyajiit/UnfoldMyMac/blob/main/UnfoldMyMac/Sources/UnfoldMyMacKit/Features/Wallpaper/Data/AuroraWallpaperProvider.swift) defines those states.
...
GTA VI — Vice City Countdown calculates the remaining calendar days in your time zone from the release date bundled with the template. It does not contact Rockstar to update that date or require an account. The [countdown implementation](https://github.com/satyajiit/UnfoldMyMac/blob/main/UnfoldMyMac/Sources/UnfoldMyMacCore/Wallpaper/WallpaperCountdown.swift) handles the date locally; [Rockstar's site](https://www.rockstargames.com/VI) is the source for the current release announcement. The website recording freezes the calendar at September 12, 2026.
...
- [Wallpaper engine, hooks, and template format](https://github.com/satyajiit/UnfoldMyMac/blob/main/UnfoldMyMac/WALLPAPER_ENGINE.md)
- [Wallpaper data provider implementation](https://github.com/satyajiit/UnfoldMyMac/tree/main/UnfoldMyMac/Sources/UnfoldMyMacKit/Features/Wallpaper/Data)
