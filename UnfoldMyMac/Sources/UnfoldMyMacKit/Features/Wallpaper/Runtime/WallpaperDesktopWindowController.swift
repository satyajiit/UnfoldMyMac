...
@MainActor final class WallpaperDesktopWindowController {
    ...
    init(screen: NSScreen, displayID: CGDirectDisplayID, pipeline: WallpaperPipeline, surface: WallpaperSurfaceModel, inputs: WallpaperInputService? = nil) {
        self.displayID = displayID
        renderer = WallpaperSurfaceRenderer(pipeline: pipeline, inputs: inputs)
        ...
        let layers = NSHostingView(rootView: WallpaperLayersRoot(surface: surface, inputs: inputs))
