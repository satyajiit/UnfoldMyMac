...
- Ten new game-themed dynamic wallpapers, each an independent tribute rendered live by original Metal shaders. Each ships the publisher's own logo and official promotional artwork, which remain their owners' property and are excluded from this project's licence; the animated backgrounds are AI-generated fan art made for this project. See [NOTICE](NOTICE) for per-file provenance and [DMCA.md](DMCA.md) for the two-hour takedown policy.
