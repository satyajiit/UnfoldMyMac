...
@MainActor final class WallpaperTemplateRegistry {
    ...
    init(shaders: WallpaperShaderCatalog, loadUserTemplates: Bool = true) throws {
        ...
        guard let bundled = Bundle.module.url(forResource: "Wallpapers", withExtension: nil, subdirectory: "Resources") else { throw CocoaError(.fileNoSuchFile) }
    ...
    func register(_ template: WallpaperTemplate) throws {
        ...
        if let image = checked.image, Bundle.module.url(forResource: image, withExtension: "png", subdirectory: "Resources/Artwork") == nil {
